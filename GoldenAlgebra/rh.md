...
* two slab-localized Backlund/Turing log envelopes (P1);
...
\;\oplus\;
\underbrace{H_{\text{entireHad}}}_{\substack{\text{entire-}\xi\text{ classical}\\\text{Hadamard theorem}}}
\;\oplus\;
\bigl(H_{\text{mid}} + H_{\text{high}} + H_{\text{lowSplit}}\bigr)
\;\Longrightarrow\;
\text{RH}.
$$
